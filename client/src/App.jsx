  ...
  return (
    <div className="sidebar">
      ...
      <ListGroup variant="flush" className="mb-4">
        <ListGroup.Item action as={Link} to="/board/general">
          Talk Lounge
        </ListGroup.Item>
        <ListGroup.Item action as={Link} to="/board/health">
          Health & Beauty
        </ListGroup.Item>
        <ListGroup.Item action as={Link} to="/board/food">
          Home & Food
        </ListGroup.Item>
      </ListGroup>
        ...
        <>
          <Row>
            <Col md={6} className="mb-4">
              <div className="d-flex justify-content-between align-items-center mb-2" style={{ borderBottom: "2px solid #f26522", paddingBottom: "5px" }}>
                <h5 className="m-0">
                  <Link to="/board/general" style={{ color: "#f26522", textDecoration: "none" }}>
                    Talk Lounge
                  </Link>
                </h5>

                <Link to="/board/general" className="text-muted small">
                  See More &raquo;
                </Link>
              </div>
            ...
            <Col md={6} className="mb-4">
              <div className="d-flex justify-content-between align-items-center mb-2" style={{ borderBottom: "2px solid #f26522", paddingBottom: "5px" }}>
                <h5 className="m-0">
                  <Link to="/board/market" style={{ color: "#f26522", textDecoration: "none" }}>
                    Marketplace
                  </Link>
                </h5>

                <Link to="/board/market" className="text-muted small">
                  See More &raquo;
                </Link>
              </div>
          ...
          <Row>
            <Col md={6} className="mb-4">
              <div className="d-flex justify-content-between align-items-center mb-2" style={{ borderBottom: "2px solid #f26522", paddingBottom: "5px" }}>
                <h5 className="m-0">
                  <Link to="/board/leagues" style={{ color: "#f26522", textDecoration: "none" }}>
                    League Info
                  </Link>
                </h5>

                <Link to="/board/leagues" className="text-muted small">
                  See More &raquo;
                </Link>
              </div>
            ...
            <Col md={6} className="mb-4">
              <div className="d-flex justify-content-between align-items-center mb-2" style={{ borderBottom: "2px solid #f26522", paddingBottom: "5px" }}>
                <h5 className="m-0">
                  <Link to="/board/life" style={{ color: "#f26522", textDecoration: "none" }}>
                    Life & Culture
                  </Link>
                </h5>

                <Link to="/board/life" className="text-muted small">
                  See More &raquo;
                </Link>
              </div>
